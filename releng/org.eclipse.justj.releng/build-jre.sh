...
#
if [[ "$ECLIPSE_URL" == "" ]]; then
  eclipse_url="https://archive.eclipse.org/eclipse/downloads/drops4/R-4.24-202206070700/eclipse-SDK-4.24$eclipse_suffix"
else
